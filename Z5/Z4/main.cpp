...
public:
    ...
    void SacuvajTekstualnuDatoteku(const std::string &s)const{
    std::fstream file(s);
    if(!file)
    ...
    file.close();
        ...
        template <typename Tip>
    void SacuvajUBinarnuDatoteku(const std::string &s);
        template <typename Tip>
    void ObnoviIzTekstualneDatoteke(const std::string &s);
        template <typename Tip>
    void ObnoviIzBinarneDatoteke(const std::string &s);
